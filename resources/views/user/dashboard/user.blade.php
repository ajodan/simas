                ...
                <div class="featured-area owl-carousel">
                    @foreach ($artikels as $artikel)
                        <div class="featured-item"
                            style="background-image: url({{ asset('storage/public/artikel/' . $artikel->photo) }});">
                                ...
                                <div class="post-bx lst brd-rd5">
                                    <div class="post-thmb">
                                        <a href="{{ route('detail-donasi-campaign', ['params' => $dn->uuid]) }}"
                                            title="" itemprop="url">
                                            <img src="{{ asset('/storage/public/campaign/' . $dn->gambar) }}"
                        ...
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            @forelse ($kegiatans as $kg)
                                <div class="event-bx brd-rd5"
                                    style="background-image: url({{ asset('/storage/public/kegiatan/' . $kg->banner) }});">
                                                ...
                                                <div class="carousel-inner">
                                                    @foreach($allFotos as $index => $foto)
                                                        <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                                            <a href="{{ asset('/storage/public/dokumentasi/' . $foto) }}" data-fancybox="gallery-{{ $dk->uuid }}">
                                                                <img src="{{ asset('/storage/public/dokumentasi/' . $foto) }}" class="d-block w-100" alt="{{ $dk->judul }}">
                                                            </a>
                                                        </div>
                                                    @endforeach
                                                </div>
                            ...
                            <div class="card shadow-sm h-100 border-0">
                                <div class="card-body text-center">
                                    ...
                                    @if ($laporan->upload_file)
                                        ...
                                        <a href="{{ asset('storage/public/laporan-keuangan/' . $laporan->upload_file) }}" target="_blank" class="btn btn-primary btn-sm">
                ...
                <div class="row">
                    @forelse ($inventaris as $item)
                        <div class="col-md-4 col-sm-6 col-lg-4 mb-4">
                            <div class="card shadow-sm h-100 border-0">
                                @if($item->photo)
                                    <img src="{{ asset('storage/public/inventaris/' . $item->photo) }}" class="card-img-top img-fluid" width="50%" height="50%" alt="{{ $item->nama_inventaris }}">
                                @endif
                                <div class="card-body text-center">
