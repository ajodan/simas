            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger nama_donatur_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <select name="jenis_donasi" id="jenis_donasi" class="form-select" data-control="select2">
                            ...
                            <option value="potongan gaji dosen">Potongan Gaji Dosen/Staff</option>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Catatan Pemasukan');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/data-donasi/donasi-manual-add', 'Tambah',
                    'Catatan Pemasukan',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/data-donasi/donasi-manual-update/' + uuid,
                    'Update',
                    'Catatan Pemasukan', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/data-donasi/donasi-manual-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Donatur Tetap', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/data-donasi/donasi-manual-delete/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/data-donasi/donasi-manual-get',
                columns: [{
                    data: null,
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Catatan Pemasukan" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
