            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="uuid_user" class="form-select" data-control="select2" id="from_select"
                    ...
                    <div class="mb-10">
                        ...
                        <select name="frekuensi" class="form-select" data-control="select2" id="from_select_frekuensi"
                            data-placeholder="Pilih jenis inputan">
                        </select>
                        <small class="text-danger frekuensi_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Donatur Tetap');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/data-donasi/donatur-tetap-add', 'Tambah',
                    'Donatur Tetap',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/data-donasi/donatur-tetap-update/' + uuid,
                    'Update',
                    'Donatur Tetap', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/data-donasi/donatur-tetap-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Donatur Tetap', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/data-donasi/donatur-tetap-delete/' + $(this).attr('data-uuid');
        ...
        $(document).on('click', '.button-list', function(e) {
            e.preventDefault();
            window.location.href = '/admin/data-donasi/donatur-tetap-list-donasi/' + $(this).attr('data-uuid');
        })
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/data-donasi/donatur-tetap-get',
                columns: [{
                    data: null,
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Donatur Tetap" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="javascript:;" data-uuid="${data}" class="btn btn-info btn-sm button-list">
                                    List Donasi </a>
                        `;
                    },
                }],
        ...
        function dataJamaah(element) {
            $.ajax({
                url: '/admin/data-jamaah-get',
                method: "GET",
        ...
        $(function() {
            dataJamaah('#from_select');
            control.push_select3(frekuensi, '#from_select_frekuensi');
            initDatatable();
        });
    </script>
@endsection
