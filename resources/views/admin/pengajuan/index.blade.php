    ...
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'update') {
                ...
                control.submitFormMultipartData('/admin/pengajuan-update/' + uuid,
                    'Update',
                    'Peminjaman Fasilitas', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/pengajuan-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Peminjaman Fasilitas', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/pengajuan-delete/' + $(this).attr('data-uuid');
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Peminjaman Fasilitas" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
