            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger kategori_id_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <textarea id="isi_artikel" class="form-control" name="isi_artikel" rows="5"
                            placeholder="Masukkan Isi Artikel"></textarea>
                        <small class="text-danger isi_artikel_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Artikel');
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/artikel-add', 'Tambah',
                    'Artikel',
                    'POST');
            } else {
                let id = $("input[name='id']").val();
                control.submitFormMultipartData('/admin/artikel-update/' + id,
                    'Update',
                    'Artikel', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            $(".title_side_form").html(`Update Artikel`);
            $(".text-danger").html("");
            let url = '/admin/artikel-show/' + $(this).attr('data-id');
            $.ajax({
                url: url,
                method: "GET",
        ...
        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/artikel-delete/' + $(this).attr('data-id');
            ...
            $('#kt_table_data').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        <a href="javascript:;" type="button" data-id="${data}" data-label="Artikel" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
