            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="nama_ustadz" class="form-control" name="nama_ustadz">
                        <small class="text-danger nama_ustadz_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Nomor Ponsel</label>
                        <input type="text" id="no_ponsel" class="form-control" name="no_ponsel">
                        <small class="text-danger no_ponsel_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <input type="file" accept="image/*" id="photo" class="form-control" width="10%" height="50%" name="photo">
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/data-ustadz-add', 'Tambah',
                    'Ustadz',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/data-ustadz-update/' + uuid,
                    'Update',
                    'Ustadz', 'POST');
            }
        });
        ...
        $(document).on('click', '#button-side-form', function(e) {
            ...
            $(".title_side_form").html(`Tambah Ustadz`);
            $(".text-danger").html("");
            // Reset form
            $(".form-data")[0].reset();
            $("#img-foto").attr("src", "");
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            $(".title_side_form").html(`Update Ustadz`);
            $(".text-danger").html("");
            let url = '/admin/data-ustadz-show/' + $(this).attr('data-uuid');
            $.ajax({
                url: url,
                method: "GET",
                    ...
                    if (res.success == true) {
                        $.each(res.data, function(x, y) {
                            ...
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                logoInfoContainer.html(
                                    `<img id="img-foto" src="/storage/public/ustadz/${y}" style="max-width:100%;">`
                                );
        ...
        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/data-ustadz-delete/' + $(this).attr('data-uuid');
                ...
                columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        result =
                            `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/storage/public/ustadz/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-100px"
                                        style="background-image:url('/storage/public/ustadz/${data}')">
                                    </div>
                                    <!--begin::Image-->
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Ustadz" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
