...
class UpdateKegiatanRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'banner.image' => 'Kolom banner harus berupa gambar.',
            'banner.mimes' => 'Kolom banner harus berupa file dengan ekstensi jpeg, png, jpg, atau gif.',
            'banner.max' => 'Ukuran file banner maksimal 2MB.',
            'tema.string' => 'Kolom tema harus berupa string.',
            'jumlah_hadir.integer' => 'Kolom jumlah hadir harus berupa angka.',
